...
import { ChevronDown, ShoppingCart, User, Settings, Search, Globe, X } from 'lucide-react';
...
export function Header() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <nav className="block md:hidden fixed top-0 w-full bg-background shadow-md z-50">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 max-w-md">
                <form onSubmit={(e) => handleSearch(e, false)} className="flex">
                  <Input
                    type="text"
                    placeholder={language === 'uz' ? 'Qidiruv...' : 'Поиск...'}
                    value={searchQuery}
