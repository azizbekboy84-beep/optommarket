      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/catalog">
              <Button className="hidden md:flex items-center gap-2 bg-gradient-to-r from-blue-600 to-red-500 hover:from-blue-700 hover:to-red-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div 
                key={index} 
                className="group bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 text-center hover:bg-gradient-to-br hover:from-blue-50 hover:to-red-50 dark:hover:from-blue-900/20 dark:hover:to-red-900/20 transition-all duration-300 transform hover:-translate-y-2 border border-transparent hover:border-blue-200 dark:hover:border-blue-800"
              >
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-red-500 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="group">
              <div className="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300">10K+</div>
              <div className="text-blue-100">{language === 'uz' ? 'Mahsulotlar' : 'Товары'}</div>
            </div>
            <div className="group">
              <div className="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300">1K+</div>
              <div className="text-blue-100">{language === 'uz' ? 'Mijozlar' : 'Клиенты'}</div>
            </div>
            <div className="group">
              <div className="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300">50+</div>
              <div className="text-blue-100">{language === 'uz' ? 'Hamkorlar' : 'Партнеры'}</div>
            </div>
            <div className="group">
              <div className="text-4xl font-black mb-2 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center gap-2">
                4.9
                <Star className="w-6 h-6 text-yellow-400 fill-current" />
              </div>
              <div className="text-blue-100">{language === 'uz' ? 'Reyting' : 'Рейтинг'}</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/partnership">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-red-500 hover:from-blue-700 hover:to-red-600 px-8 py-4 text-lg font-semibold rounded-xl group">
                {language === 'uz' ? 'Hamkor Bo\'ling' : 'Стать Партнером'}
                <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            <Link href="/contact">
              <Button variant="outline" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-gray-900 px-8 py-4 text-lg font-semibold rounded-xl">
